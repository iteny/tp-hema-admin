...
<body>
<div id="frame-top">
    当前位置&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60e;</i>&nbsp;&nbsp;设置&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;站长设置&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;菜单设置&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;添加菜单
</div>
<div id="frame-toolbar">
    <ul>
        <li><a href="/intendant/Site/menu"><i class="iconfont" style="color:white;font-size: 16px;">&#xe611;</i>&nbsp;&nbsp;菜单设置</a></li>
        <li><a class="active" href="/intendant/Site/addEditMenu"><i class="iconfont" style="color:white;font-size: 16px;">&#xe610;</i>&nbsp;&nbsp;添加菜单</a></li>
    </ul>
</div>
<div id="frame-content">
    <form name="addMenu" method="post" class="J_ajaxForm" action="/intendant/Site/addEditMenu" novalidate="novalidate">
        <input type="hidden" name="addEditMenu" value="addEditMenu">

        <div class="frame-table-list">
            <div class="input-title">添加菜单</div>
            <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
                ...
                <tr>
                    ...
                    <td>
	                  ...
	                  <?php if(is_array($selectMenu)): $i = 0; $__LIST__ = $selectMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $pid): ?>selected<?php endif; ?>><?php echo str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$vo['level']); if($vo["level"] > 0): ?>├─<?php endif; echo ($vo["html"]); echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </td>
                </tr>
                <tr>
                    <td>菜单名称:</td>

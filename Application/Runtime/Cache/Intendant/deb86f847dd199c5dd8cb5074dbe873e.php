...
<div id="frame-content">
    <form name="export" class="ajax-form" action="/Intendant/Site/" method="post">
        <div class="frame-table-list">
            <table width="100%">
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	              <td align="center"><?php echo ($vo["file"]); ?></td>
	              <td align="center"><?php echo ($vo["time"]); ?></td>
	              <td align="center"><?php echo ($vo["size"]); ?></td>
	              <td align="center" class="action">
	              	<a class="ajax-import blue" href="/Intendant/Site/sendFileZip/file/<?php echo ($vo["file"]); ?>"><i class="iconfont" style="color:white;font-size: 16px;">&#xe610;</i>&nbsp;&nbsp;发送的指定邮箱</a>&nbsp;&nbsp;&nbsp;
	              	<a class="ajax-del red" data-title="<?php echo ($vo["file"]); ?>" data-type="备份文件" href="/Intendant/Site/delFileBackup" data-id="<?php echo ($vo["file"]); ?>"><i class="iconfont" style="color:white;font-size: 16px;">&#xe614;</i>&nbsp;&nbsp;删除</a>      
	              </td>
        ...
        <div class="frame-table-btn">
            ...
            <button class="btn" style="float:right;margin-right: 40px;">服务器共有<?php echo ($files); ?>个文件备份，共计<?php echo ($total); ?></button>
        </div>
    </form>
</div>
</body>

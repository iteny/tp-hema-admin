    ...
    <form name="commonSort" class="ajax-form" action="/admin/Site/sortUser" method="post">
        <div class="frame-table-list">
            <table width="100%">
                ...
                <tbody>
                <?php if(is_array($loginlist)): $i = 0; $__LIST__ = $loginlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><tr>
                    <td align="center"><?php echo ($log["id"]); ?></td>
                    <td align="center"><?php echo ($log["username"]); ?></td>
                    <td align="center"><?php echo ($log["info"]); ?></td>
                    ...
                    <td align="center"><?php echo (date("Y年m月d日 h:i:s",$log["logintime"])); ?></td>
                    <td align="center"><?php echo ($log["loginip"]); ?></td>

...
<body>
<div id="frame-top">
    当前位置&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60e;</i>&nbsp;&nbsp;设置&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;站长设置&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;开发日志管理&nbsp;&nbsp;<i class="iconfont" style="color:#666;font-size: 12px;">&#xe60f;</i>&nbsp;&nbsp;修改开发日志(<?php echo (date("Y-m-d",$verson["time"])); ?>)
</div>
...
<div id="frame-content">
    <form name="editVersion" method="post" class="J_ajaxForm" action="/Intendant/Site/addEditVersion" novalidate="novalidate">
        ...
        <div class="frame-table-list">
            <div class="input-title">修改开发日志(<?php echo (date("Y-m-d",$verson["time"])); ?>)</div>
            <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
                <tbody>
                <tr>
                    <td width="140">版本号:</td>
                    <td><input type="text" class="input length_5" name="version" value="<?php echo ($version["version"]); ?>" id="version"></td>
                </tr>
                <tr>
                    <td width="140">日志内容:</td>
                    <td ><script id="content" name="remark" type="text/plain" style="width:100%;height:500px;">
                    <?php echo (stripslashes(htmlspecialchars_decode($version["remark"]))); ?>
                    </script>

    	...
    	<table width="100%">
            ...
            <tbody>
                <?php if(is_array($table_data_list)): $i = 0; $__LIST__ = $table_data_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>                        
                        ...
                        <?php if(!empty($sort)): ?><td align="center" width="40"><input style="text-align: center" name="sort[<?php echo ($data[$table_data_list_key]); ?>]" type="text" size="3" value="<?php echo ($data[$sort]); ?>" class="input"></td><?php endif; ?>

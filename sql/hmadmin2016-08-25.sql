...
-- ----------------------------
INSERT INTO `hm_config` VALUES ('1', '站长设置', '', '11', '0', '', '', '0', '1');
INSERT INTO `hm_config` VALUES ('2', '后台缓存设置', '', '22', '0', '', '', '0', '1');
INSERT INTO `hm_config` VALUES ('3', '数据备份设置', '', '33', '0', '', '', '0', '1');
INSERT INTO `hm_config` VALUES ('4', '邮箱设置', '', '44', '0', '', '', '0', '1');
INSERT INTO `hm_config` VALUES ('5', '阿萨德发射点发', '', '55', '1', '', '', '0', '0');
INSERT INTO `hm_config` VALUES ('6', 'adfasd', '', '66', '1', '', '', '0', '0');
...
CREATE TABLE `hm_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=352 DEFAULT CHARSET=utf8 COMMENT='后台登陆日志表';

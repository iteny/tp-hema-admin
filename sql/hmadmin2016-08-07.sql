...
INSERT INTO `hm_auth_rule` VALUES ('127', 'sadfsadf', '阿斯蒂芬', '1', '1', '', '126', '1', '1', '');
...
CREATE TABLE `hm_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=340 DEFAULT CHARSET=utf8 COMMENT='后台登陆日志表';
